...
WMapSelectDialog::WMapSelectDialog() {
  ...
  for (size_t index = 0; index < AvailableMaps.size(); ++index) {
    ...
    buttonPtr->SetColors(GetColor(40, 45, 55), GetColor(0, 120, 215), GetColor(0, 90, 160));
  ...
  m_BtnCancel->SetColors(GetColor(60, 50, 50), GetColor(150, 70, 70), GetColor(110, 45, 45));
