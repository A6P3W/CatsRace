...
WPostGameDialog::WPostGameDialog()
{
	...
	auto btnPlayAgain = std::make_unique<UIBoxButtonComponent>(200.0f, 45.0f, GetColor(40, 45, 55), GetColor(0, 120, 215), GetColor(0, 90, 160));
	...
	auto btnBackToTitle = std::make_unique<UIBoxButtonComponent>(200.0f, 45.0f, GetColor(40, 45, 55), GetColor(0, 120, 215), GetColor(0, 90, 160));
...
void WPostGameDialog::SetOnResult(FOnPostGameResult callback)
{
	m_Callback = callback;
}
