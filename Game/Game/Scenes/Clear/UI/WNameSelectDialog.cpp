...
WNameSelectDialog::WNameSelectDialog() {
  ...
  auto btnUseExisting = std::make_unique<UIBoxButtonComponent>(
      400.0f, 45.0f, GetColor(40, 45, 55), GetColor(0, 120, 215), GetColor(0, 90, 160)
  );
  ...
  auto btnEnterNew = std::make_unique<UIBoxButtonComponent>(
      400.0f, 45.0f, GetColor(40, 45, 55), GetColor(0, 120, 215), GetColor(0, 90, 160)
  );
  ...
  // 3. Skip Button
  auto btnSkip = std::make_unique<UIBoxButtonComponent>(
      400.0f, 45.0f, GetColor(40, 45, 55), GetColor(0, 120, 215), GetColor(0, 90, 160)
  );
