...
using FetchLeaderBoardCallBack =
    std::function<void(bool bSuccess, const std::vector<FLeaderBoardEntry>&)>;
using FetchGhostDataCallBack = std::function<
    void(bool bSuccess, const std::unordered_map<std::string, std::string>& GhostDataById)>;
